...
def enrichr_run_dual(base_url: str, up: List[str], dn: List[str], libraries: List[str]) -> Dict[str, Dict]:
    """Run Enrichr for UP and DN lists across libraries."""
    results: Dict[str, Dict] = {}
    up_id = enrichr_add_list(base_url, up, description="UP")
    dn_id = enrichr_add_list(base_url, dn, description="DN")
