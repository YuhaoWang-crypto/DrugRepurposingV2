...
def l1000fwd_sig_search(base_url: str, up: List[str], dn: List[str], timeout: int = 120) -> str:
    """
    ...
    # Surface the server payload to help debugging (e.g., "error" field).
    raise RuntimeError(f"No result_id returned. keys={keys[:12]} preview={str(res)[:200]}")
